...
o repositório Git para controle de versão, o quadro Kanban para gerenciamento de Projetos, e \textit{Pipelines}
para Integração Contínua e processo de \textit{Deployment}.
...
No estado atual do trabalho, a arquitetura do sistema e seu processo de desenvolvimento foram
definidos.
